...
- 原稿从 15 号直接跳到 17 号，没有第 16 号角色定义。程序保留 `unreleased_16` 占位以维持编号完整，但不会让其进入对局。
...
- 火龙、比格小星、ED Tear、苯环、葱头、错潮、厄瑞玻斯、柳七鱼、久孤、薯条、澪叁贰玖、青桃、罗兹、罗丁、混、堤谧特和沙白的专属机制均已接入。
- 没有专属能力文本的 HKW、白龙、端、斜阳、花尔维纳和小五仍完整参与性格、状态、搜索、信息、装备和来访系统。
...
- 抽牌为抽三选一；可以反悔取消，也可交出一件紫色及以上物资改变所选牌的正逆位。
- 审判在伪人初访后才进入可抽范围。
