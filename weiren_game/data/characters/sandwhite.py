...
CHARACTER = CharacterDefinition(
    ...
    ("高中生", "16-18岁", "女性"),
    (A("ordinary", "万事通", "沙白在搜索返回时有30%可能获得一件额外物资。每个回合开始时有20%可能使创伤强度≤3的房客创伤强度-3。（该效果有3个回合冷却时间。）", chips=("冷却 3 回合",)),
     A("slow_perception", "感知迟钝／困倦", "沙白的理智消耗/增加量均*50%；沙白在入住时理智为50。沙白在搜索返回后，接下来3个回合不能进行搜索。")),
    (A("encourage", "鼓舞", "令所有房客回复2理智，持续3回合。*该能力有2回合冷却时间。", chips=("冷却 2 回合",)),),
)
