...
CHARACTER = CharacterDefinition(
    ...
    (A("permission_transfer", "权限转让", "**首次**发动时，混先让自己消耗1层理智、换来1层癫狂；此后不再消耗。发动时二选一：·让一名房客**代你出手**（它付出10生命与10理智，使用其主动能力；可无视回合、对局限制）。·**收走**一名房客身上的一道伤、或一团乱（其创伤或紊乱层数-1、强度-1）。", "tenant", chips=("每回合 1 次",), options=(("imitate","代我出手"),("trauma","收走那道伤"),("disorder","收走那点乱")), nested_option="imitate", per_turn=True),),
)
