...
CHARACTER = CharacterDefinition(
    ...
    (A("chaotic_personality", "混沌的性格／纯真的自我", "每回合开始时，混的主性格与副性格分别在八个性格中随机切换，混的可携带物资数在1~4之间随机切换。当混的理智层数≥10时，混可以固定自己的主性格与副性格，且主性格权重变为2.0；可携带物资数固定为4。"),
     A("reason_madness", "情绪显现-理智／癫狂", "混在屋内时，屋主可以看到所有房客的理智与癫狂的强度、层数，理智/癫狂的强度固定为1，获得额外效果。理智：回合末消耗理智-5。癫狂：回合末消耗理智+10，当层数≥10时，在回合开始，消耗所有额外的癫狂，并转化为相同层数的创伤与紊乱。"),
    ...
    (A("permission_transfer", "权限转让", "**首次**发动时，混先让自己消耗1层理智、换来1层癫狂；此后不再消耗。发动时二选一：·让一名房客**代你出手**（它付出10生命与10理智，使用其主动能力；可无视回合、对局限制）。·**收走**一名房客身上的一道伤、或一团乱（其创伤或紊乱层数-1、强度-1）。", "tenant", chips=("每回合 1 次",), options=(("imitate","代我出手","i-hand","让对方用它的主动能力出手"),("trauma","收走那道伤","i-trauma","创伤层数-1、强度-1"),("disorder","收走那点乱","i-disorder","紊乱层数-1、强度-1")), nested_option="imitate", per_turn=True),),
)
