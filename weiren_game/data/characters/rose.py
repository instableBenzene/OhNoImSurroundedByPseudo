...
CHARACTER = CharacterDefinition(
    ...
    (A("rose_recover", "风花雪月／该我上场了？", "消耗1层印记。为自身回复5生命或5理智；若拥有【魔化印记-罗兹】，则额外消耗1层【魔化印记-罗兹】，对所有房客造成5点生命伤害，并使自身回复等额的理智。*每个回合仅能使用1次。", "resource", prompt="回复哪种资源？", options=(("health","生命","i-cross","回复 5 点生命"),("sanity","理智","i-emotion","回复 5 点理智")), chips=("每回合 1 次",), per_turn=True),
