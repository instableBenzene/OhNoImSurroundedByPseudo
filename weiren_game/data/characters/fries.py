...
CHARACTER = CharacterDefinition(
    ...
    (A("odd_belongings", "莫名带点东西", "薯条在入住时会带来一把“燧发枪”和两枚“弹药-燧发枪”。燧发枪（金色）【工具】【易损品】·在搜索中受到伪人主动能力影响时，有25%可能免疫该能力影响，消耗一个【弹药-燧发枪】，将概率提升为100%·触发后有25%可能被消耗，若消耗了弹药-燧发枪则改为5%一个较为古典的燧发枪，不到必要关头，薯条不会浪费他的子弹。弹药-燧发枪（紫色）【工具】【消耗品】【可堆叠】·可被燧发枪消耗。薯条制作的燧发枪子弹，尽管逊色于机器制造的子弹，威力仍不容小觑。"),
     A("odd_luck", "莫名的幸运B", "薯条搜索时遭遇伪人概率-6%；有40%可能额外获得1件随机物资；有15%可能获得一个【人设-薯条】。")),
    (A("deep_thought", "深度思考", "薯条获得一个【人设-薯条】。薯条最多同时持有2个【人设-薯条】；若获得第3个，则随机移除其中1个，且优先移除互斥的【人设-薯条】。各人设的机制与描述见下方「人设」一栏", chips=("每次对局 1 次",)),),
)
