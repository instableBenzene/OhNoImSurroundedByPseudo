...
CHARACTER = CharacterDefinition(
    ...
    (A("walmart_bag", "我是一个沃尔玛购物袋", "ED Tear在入住时会带来一个“沃尔玛购物袋”。沃尔玛购物袋（金色）【工具】【易损品】·使持有者的可携带物资数+5，搜索返回后有25%可能被消耗。·若携带者为ED Tear，搜索返回后消耗概率-10%。一个普通的超市购物袋，但对ED来说，他即是塑料袋，塑料袋即是他。"),
