...
CHARACTER = CharacterDefinition(
    ...
    (A("sharp_instinct", "敏锐直觉", "澪叁贰玖在满足下列条件时会获得【警觉印记-澪叁贰玖】（以下简称印记），最多持有三个印记：·澪叁贰玖在屋内时，有15%可能识破可被接纳的伪人，并获得1个印记。·澪叁贰玖在屋内遭遇一次伪人来访后，此后每个回合都会获得1个印记。持有印记时，澪叁贰玖回合末理智消耗+50%；免疫来自侵蚀情绪集的状态效果；每个回合开始时有25%可能获得一条待验证信息，若屋内有伪人时，概率提升为65%。*仅会获得物资信息、和来访信息-伪人来访、伪人技能触发提示、指认房间内的伪人信息"),),
    (A("information_collect", "情报收集", "消耗1层印记，识破一条物资信息。且在本回合指派澪叁贰玖搜索，搜索回合数-1，可携带物资数+1。*该能力有3回合冷却时间。", "information", chips=("冷却 3 回合",)),
     A(
         "intent_awareness",
         "意图觉察／决策",
         "消耗任意层印记，获得等量的待验证信息；且可以选择额外消耗30理智，识破这些信息。*仅会获得和来访信息-伪人来访、伪人技能触发提示",
         "amount",
         prompt="选择要消耗的警觉印记层数",
